...
public record ModularShaftWeaponDataComponent(
	...
	public static final Codec<ModularShaftWeaponDataComponent> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
							...
							TagKey.hashedCodec(Registries.ITEM).fieldOf("head_items").forGetter(ModularShaftWeaponDataComponent::head_items),
							TagKey.hashedCodec(Registries.ITEM).fieldOf("pommel_items").forGetter(ModularShaftWeaponDataComponent::pommel_items),
