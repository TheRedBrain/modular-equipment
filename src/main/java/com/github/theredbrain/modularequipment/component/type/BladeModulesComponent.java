...
public record BladeModulesComponent(
	...
	public static final Codec<BladeModulesComponent> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
							...
							TagKey.hashedCodec(Registries.ITEM).fieldOf("grip_items").forGetter(BladeModulesComponent::grip_items),
	...
	public record BladeModules(
		...
		public static final BladeModules DEFAULT = new BladeModules(ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY);
		public static final Codec<BladeModulesComponent.BladeModules> CODEC = RecordCodecBuilder.create(
				instance -> instance.group(
								...
								ItemStack.CODEC.optionalFieldOf("grip_component", ItemStack.EMPTY).forGetter(BladeModulesComponent.BladeModules::grip_component)
						)
